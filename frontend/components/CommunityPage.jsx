...
export function CommPg({ t, lang, back, onLang, user }) {
      ...
      <div className="comm-wrap">
        <div className="comm-side">
          ...
          <div className={`prof-row${tab === "profile" ? " act" : ""}`} onClick={() => setTab("profile")}>
            <div className="pr-av">{user?.name?.charAt(0).toUpperCase()}</div>
            <div><div className="pr-n">{user?.name}</div><div className="pr-t">{t.profile}</div></div>
          </div>
        </div>
        <div className="comm-main">
          {tab === "chat" ? (
            ...
            <div className="prof-panel">
              <div className="ph">
                <div className="p-big-av">{user?.name?.charAt(0).toUpperCase()}</div>
                <div><div className="p-name">{user?.name}</div><div className="p-sub">Farmer · Joined Jan 2024</div></div>
